            ...
            <div class="row w-100 m-0">
                ...
                <div class="col-10 p-0" style="min-height: 620px;">
                    ...
                    <div class="d-flex px-3 align-items-center">
                        ...
                        <a href="report_5.php"> <button type="button" class="btn btn-outline-secondary"
                                style="border-radius: 0px; margin-right: 2px; width: 70px;">กราฟ</button></a>


                        <a href="report_5_table.php"><button type="button" class="btn btn-outline-secondary mr-1 active"
                    ...
                    <div class="bg-white mx-3 mb-3 mt-0 pt-3"
                        ...
                        <div id="columnchart_material" style="width:100%;" class="p-0">
                            <div class="row m-0 w-100 py-3 px-0" style="box-shadow: 0 2px 0 0 #1633ff;">
                                <div class="col-4 p-0">
                                    <div class="d-flex justify-content-center">
                                        <span class="title_table_top10">ประเภทการชำระเงิน</span>
                                    </div>
                                </div>
                                <div class="col-4 p-0">
                                    <div class="d-flex justify-content-center">
                                        <span class="title_table_top10">จำนวนออเดอร์</span>
                                    </div>
                                </div>
                                <div class="col-4 p-0">
                                    <div class="d-flex justify-content-center">
                                        <span class="title_table_top10">ยอดขายรวม</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            while($row = mysqli_fetch_array($query)){
                                ...
                                $queryQuantity = mysqli_query($conn, "SELECT COUNT(payment_id) AS numQuantity FROM paymet_history WHERE date_payment BETWEEN '$dateSearch' AND '$dateSearch_2' AND payment_type = '".$payment_type."'");
                            ...
                            <div class="row w-100 m-0 px-0 py-2" style="box-shadow: 0 1px 0 0 #e9e9e9;">
                                <div class="col-4 p-0">
                                    <div class="d-flex justify-content-center">
                                        <span class="text-discription-top10"><?php echo $type; ?></span>
                                    </div>
                                </div>
                                <div class="col-4 p-0">
                                    <div class="d-flex justify-content-center">
                                        <span
                                            class="text-discription-top10"><?php echo number_format($quantity); ?></span>
                                    </div>
                                </div>
                                <div class="col-4 p-0">
                                    <div class="d-flex justify-content-center">
                                        <span
                                            class="text-discription-top10"><?php echo number_format($income); ?></span>
                                    </div>
                                </div>
