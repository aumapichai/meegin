...
<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto">
        ...
        <div class="d-flex align-items-center border-kitchen">
            <img src="../picture/admin.png" class="img-kitchen-nav" alt="">
            <span class="text-kitchen-1">ผู้ดูแล</span>
        </div>
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            ...
            <div class="info">
                <div class="d-block text-white"><span
                        style="color: #01cbdb; font-weight: 500;">ผู้ดูแล</span><?php echo ' '.$_SESSION['fname']; ?>
                </div>
            </div>
        </div>
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="expense.php" class="nav-link <?php if($active == "รายจ่าย"){  echo " active"; } ?>">
                ...
                <li class="nav-item">
                    <a href="report_1.php" class="nav-link <?php if($active == "รายงาน"){  echo " active"; } ?>">
                ...
                <li class="nav-item">
                    <a href="category.php" class="nav-link <?php if($active == "สินค้า"){  echo " active"; } ?>">
                ...
                <li class="nav-item">
                    <a href="employee.php" class="nav-link <?php if($active == "พนักงาน"){  echo " active"; } ?>">
