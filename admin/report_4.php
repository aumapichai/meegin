                ...
                <div class="col-10 p-0" style="min-height: 620px;">
                    ...
                    <div class="d-flex px-3 align-items-center">
                        ...
                        <a href="report_4no.php">
                            <button type="submit" class="btn btn-outline-secondary mr-1" style="border-radius: 0px;">10
                                สินค้าขายไม่ดี
                            </button>
                        </a>
                    ...
                    <div class="bg-white mx-3 mb-3 mt-0"
                        style="box-shadow: 0 0 1px rgb(0 0 0 / 13%), 0 1px 3px rgb(0 0 0 / 20%); border-radius: 2px;">
                        <div class="d-flex p-3 align-items-center">
                            <a href="report_4.php"><button type="button"
                                    class="btn btn-outline-secondary btn-sm active mr-1"
                                    style="width: 60px;">กราฟ</button></a>
                            <a href="report_4_table.php"><button type="button" class="btn btn-outline-secondary btn-sm"
                        ...
                        function drawChart() {
                            var data = google.visualization.arrayToDataTable([
                                ...
                                $queryTop10 = mysqli_query($conn, "SELECT SUM(quanity) AS numQuantity, food_id FROM orderdetail WHERE date_orderdetail BETWEEN '$dateSearch' AND '$dateSearch_2' AND orderDetail_status = 'successfully' AND problem_status	= 'no problem' GROUP BY food_id ORDER BY SUM(quanity) DESC LIMIT 0, 9");
                                while($row = mysqli_fetch_array($queryTop10)){
                                    ...
                                    // $queryT10_2 = mysqli_query($conn, "SELECT SUM(price_discount) AS income, food_id FROM orderdetail WHERE date_orderdetail BETWEEN '$dateSearch' AND '$dateSearch_2' GROUP BY food_id");
                                    echo "['".$nameFood."', ".$numQuantity."],";
                                }
                            ...
                            var options = {
                                chart: {
                                    title: 'กราพแสดง 10 อันดับสินค้าขายดี',
                                    subtitle: 'รายงานวันที่ <?php echo date("d/m/Y", strtotime($dateSearch)).' ถึง '.date("d/m/Y", strtotime($dateSearch_2)); ?>',
                                },
                        ...
                        <div id="barchart_material" style="width:100%; height: 600px;" class="px-3 pt-0 pb-3"></div>
