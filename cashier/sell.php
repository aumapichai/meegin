...
if (isset($_POST['getDetailOrder'])) {
    ...
    $respone .= '<div class="bg-white rounded mt-2" style="box-shadow: 0 0.5rem 1rem rgb(0 0 0 / 15%);">
        ...
        <div class="d-flex" style="background: #4caf50;">
            <div class="col-2 p-0">
                <!-- active-a -->
        ...
        <div class="d-flex pt-3 pb-2" style="box-shadow: 0 2px 0 0 #4caf50;">
            <div class="col-2">
                <div class="d-flex">
    ...
    while ($row2 = mysqli_fetch_array($query2)) {
        ...
        <div class="col-1">
            ...
            <div class="col-2">
                ...
                <button type="button"
                class="btn btn-danger btn-sm btn-cancel-cashier btn-cancal-food-order" value="' . $orderDetailId . '"
                 ' . $notCancel . '>ยกเลิก</button>
                </div>
            </div>
        </div>';
    }
    ...
    $respone .= '</div>
        <div class="d-flex justify-content-end"
            style="background: #4caf50; border-radius: 0 0 4px 4px;">
...
if (isset($_POST['chekBill'])) {
    ...
    mysqli_query($conn, "INSERT INTO paymet_history (payment_reference, food_reference, payment_amount, payment_type, payment_table, payment_from) VALUES ('PM-" . rand(100, 999) . date("dmYHis") . rand(100, 999) . "', '$idReference', '$amount', 'cash', '$table_number3', '" . $_SESSION['fname'] . "')");
    exit($idReference);
}
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-outline-dark btn-print-QRcode">พิมพ์</button>
                        ...
                        <div class="modal-dialog mondal-dialog-check-bill" id="">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="button" class="btn btn-success btn-payment-money" style="width: 90px;" data-table="<?php echo $tableNumber; ?>">ชำระ</button>
                                </div>
